...
class AdminCategorieController extends AbstractController
{
    ...
    /**
     * @Route("/new", name="admin.categorie.new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="admin.categorie.edit", methods={"GET","POST"})
     */
    ...
    {
        if ($this->isCsrfTokenValid('admin.delete'.$categorie->getId(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
