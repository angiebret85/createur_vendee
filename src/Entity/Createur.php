...
class Createur
{
    ...
    public function getMinidescriptif(): ?string
    {
        return $this->minidescriptif;
    }

    public function setMinidescriptif(string $minidescriptif): self
    {
        $this->minidescriptif = $minidescriptif;
